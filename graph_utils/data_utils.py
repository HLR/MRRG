...
from graph_utils.tokenization_utils import *
    ...
    def load_qa_dataset(dataset_path):
        ...
        with open(dataset_path, "r", encoding="utf-8") as fin:
            ...
            for line in fin:
                ...
                label = ord(input_json['question'].get("answer_label_as_choice", "A")) - ord("A")
                output.append((input_json['metadata']['ques_id'], input_json["question"]["stem"], *[ending["text"] for ending in input_json["question"]["choices"]], label))
        return output
    ...
    def read_examples(input_file):
        with open(input_file, "r", encoding="utf-8") as f:
            ...
            for line in f.readlines():
                ...
                label = ord(json_dic['question']["answer_label_as_choice"]) - ord("A") # if 'answer_label_as_choice' in json_dic else 0
                examples.append(
                    InputExample(
                        example_id=json_dic["metadata"]['ques_id'],
                        contexts=[" ".join(json_dic["question"]['para_steps'])],
