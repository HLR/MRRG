...
def load_matcher(nlp, pattern_path):
    ...
    for concept, pattern in all_patterns.items():
        ### chen
        ### python 3.6 
        matcher.add(concept, None, pattern) ### v2: https://stackoverflow.com/questions/66164156/problem-with-using-spacy-matcher-matcher-matcher-add-method
        ### python 3.7
        # matcher.add(concept, pattern)  ### v3
    return matcher
...
def ground_qa_pair(qa_pair):
    ...
    if nlp is None or matcher is None:
        ...
        ### chen: python 3.6
        nlp.add_pipe(nlp.create_pipe('sentencizer')) ## v2 version. Solution: https://github.com/explosion/spaCy/discussions/7743
        ### chen: python 3.7
        # nlp.add_pipe('sentencizer') ## v3 version
